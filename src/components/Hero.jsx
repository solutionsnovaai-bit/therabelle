  ...
  return (
    ...
    >
      ...
      <div
        ref={textRef}
        style={isMobile
          ? { padding: '55svh 24px 64px', width: '100%', position: 'relative', zIndex: 2 }
      ...
      >
        ...
        <h1 style={{ fontFamily: "'Playfair Display',serif", fontWeight: 700, fontSize: isMobile ? 'clamp(2.1rem,8vw,2.5rem)' : 'clamp(2.4rem,6vw,4.2rem)', lineHeight: 1.12, margin: '18px 0 22px', color: 'var(--color-ink, #34281B)', display: 'flex', flexWrap: 'wrap', alignItems: 'baseline', columnGap: '0.26em', rowGap: '0.05em' }}>
        ...
        <p style={{ fontSize: '17px', lineHeight: 1.7, color: 'var(--color-ink, #34281B)', maxWidth: '440px', margin: isMobile ? '0 0 22px' : '0 0 34px', fontWeight: 500 }}>
          {HERO.subtitle}
        </p>

        {reducedMotion ? (
          <p style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: isMobile ? '12px 0 18px' : '18px 0 26px', flexWrap: 'wrap' }}>
          ...
          <>
            <p aria-hidden="true" style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: isMobile ? '12px 0 18px' : '18px 0 26px', flexWrap: 'wrap' }}>
