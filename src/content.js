...
export const CLINIC_PHOTOS = [
  { src: '/clinica-sala-massagem.jpg', alt: 'Sala de massagem da Thera Belle com maca e logotipo na parede' },
  { src: '/clinica-sala-estar.jpg', alt: 'Sala de estar da Thera Belle com sofá preto e vista para o jardim interno' },
  { src: '/clinica-jardim-interno.jpg', alt: 'Jardim interno da Clínica Thera Belle com parede de pedras e plantas' },
  { src: '/clinica-espera-detalhes.jpg', alt: 'Área de espera da Thera Belle com parede de tijolinhos e poltrona' },
  { src: '/clinica-cantinho-cafe.jpg', alt: 'Cantinho do café da recepção da Thera Belle' },
  { src: '/clinica-parede-assinatura.jpg', alt: 'Parede de tijolinhos com assinatura "It\'s beauty o\'clock" e espelho dourado' },
  { src: '/clinica-espelho-dourado.jpg', alt: 'Espelho dourado e parede de tijolinhos da Thera Belle' },
  { src: '/clinica-recepcao-logo.jpg', alt: 'Recepção da Thera Belle com logotipo em relevo dourado na parede' },
  { src: '/clinica-poltrona-leitura.jpg', alt: 'Poltrona de descanso com luminárias de madeira na Thera Belle' },
];
...
export const HEROINAS = {
  eyebrow: 'QUEM DÁ VIDA À THERA BELLE',
  titlePlain: 'Júlia e Andréa, ',
  titleEm: 'juntas por você',
  photo: '/equipe-julia-andrea.jpg',
  photoAlt: 'Júlia e Andréa juntas na recepção da Thera Belle, em frente ao logotipo',
  paragraphs: [
    'Uma cuida da estética, a outra do bem-estar — e as duas dividem o mesmo espaço, o mesmo cuidado e a mesma vontade de ver você saindo melhor do que entrou.',
    'É essa parceria que dá o tom da experiência na Thera Belle: técnica de sobra, pressa nenhuma, e um ambiente pensado para você relaxar em cada visita.',
  ],
};
...
export const BEM_ESTAR = {
  ...
  items: [
    ...
    { name: 'Thera Hot Stones Massage', desc: 'Massagem com pedras quentes que dissolve tensões profundas e devolve o calor ao corpo.' },
  ],
};
...
export const SUA_VISITA = {
  ...
  photo: '/clinica-sala-massagem.jpg',
  photoAlt: 'Sala de tratamento da Thera Belle com maca e logotipo na parede, em Piracicaba',
};
